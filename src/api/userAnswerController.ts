...
export async function listUserAnswerUsingPost(
  ...
  return request<API.BaseResponsePageResultUserAnswerVO_>(
    "/aiaq/userAnswer/list",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
/** getUserAnswerVoByIdUsingGet Get /aiaq/userAnswer/get/{userAnswerId} */
export async function getUserAnswerVoByIdUsingGet(
  params: API.UserAnswerGetByIdRequest,
  options?: { [key: string]: any }
) {
  const { userAnswerId: param0, ...queryParams } = params;
  return request(`/aiaq/userAnswer/get/${param0}`, {
    method: "Get",
    headers: {
      "Content-Type": "application/json",
    },
